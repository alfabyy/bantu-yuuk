        ...
        ***********************************-->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('pengguna.destroy', $item->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="modal-body">
                        <form action="{{ route('layanan.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jenis_layanan" class="form-control input-default" placeholder="Masukkan Jenis Layanan" required>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Nama Layanan</h5>
                                <input type="text" name="nama_layanan" class="form-control input-default" placeholder="Masukkan Nama Layanan" required>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Harga</h5>
                                <input type="number" name="harga" class="form-control input-default" placeholder="Rupiah" required>
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel{{ $item->id }}">Edit Layanan</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('layanan.update', $item->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <h5 class="card-title">Jenis Layanan</h5>
                                <input type="text" name="jenis_layanan" class="form-control input-default" value="{{ old('jenis_layanan', $item->jenis_layanan) }}" placeholder="Masukkan Jenis Layanan" required>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Nama</h5>
                                <input type="text" name="nama_layanan" class="form-control input-default" value="{{ old('nama_layanan', $item->nama_layanan) }}" placeholder="Masukkan Nama" required>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Harga</h5>
                                <input type="number" name="harga" class="form-control input-default" value="{{ old('harga', $item->harga) }}" placeholder="Masukkan Harga" required>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Deskripsi</h5>
        ...
        <div class="modal fade" id="viewModal{{ $item->id }}" tabindex="-1" aria-labelledby="viewModalLabel{{ $item->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="viewModalLabel{{ $item->id }}">Edit Layanan</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('layanan.update', $item->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <h5 class="card-title">Jenis Layanan</h5>
                                <input type="text" name="jenis_layanan" class="form-control input-default" value="{{ old('jenis_layanan', $item->jenis_layanan) }}" placeholder="Masukkan Jenis Layanan" readonly>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Nama</h5>
                                <input type="text" name="nama_layanan" class="form-control input-default" value="{{ old('nama_layanan', $item->nama_layanan) }}" placeholder="Masukkan Nama" readonly>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Harga</h5>
                                <input type="number" name="harga" class="form-control input-default" value="{{ old('harga', $item->harga) }}" placeholder="Masukkan Harga" readonly>
                            </div>
                            <div class="form-group">
                                <h5 class="card-title">Deskripsi</h5>
